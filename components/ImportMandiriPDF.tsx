    ...
    <>
      ...
      {showPasswordInput ? (
        ...
        <div
          ...
          className={`group relative flex h-full min-h-[140px] cursor-pointer flex-col items-center justify-center gap-2 rounded-[2rem] border-2 border-dashed
            bg-slate-50/50 dark:bg-slate-800/20 p-4 text-center transition-all duration-200
            hover:border-primary/40 hover:bg-primary/5 dark:hover:border-primary/30 dark:hover:bg-primary/10
            ${drag ? "border-primary bg-primary/10 dark:bg-primary/20 scale-[1.02]" : "border-slate-200 dark:border-slate-700"}
        ...
        >
          ...
          <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-2xl bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700/50 p-2 sm:p-2.5 transition-transform group-hover:scale-110">
            {loading ? (
